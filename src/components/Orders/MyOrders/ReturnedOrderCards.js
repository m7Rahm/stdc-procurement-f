    ...
    return (
        <div style={{ cursor: "pointer" }} id={props.orderid} onClick={props.handleCardClick}>
            ...
            >
                ...
                >
                    <div className="order-card-info-number-wrap" style={{ backgroundColor: props.order[0].emp_id !== userData.userInfo.id ? "rgb(217, 52, 4)" : "", alignSelf: "baseline" }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', height: "174px", overflow: "auto", width: "90%" }}>
